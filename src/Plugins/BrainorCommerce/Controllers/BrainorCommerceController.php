...
namespace Zeus\Admin\Plugins\BrainorCommerce\Controllers;
...
class BrainorCommerceController extends Controller
{
    private $pluginData = [
        'redirectUrl' => '',
        'sectionPath' => 'Zeus\Admin\Plugins\BrainorCommerce\Sections\\'
    ];

    public function __construct()
    {
        $this->pluginData['redirectUrl'] = '/' . config('zeusAdmin.admin_url') . '/BrainorCommerce/{sectionName}';
    }
